...
## Translation Guidelines (specifically for Portuguese (Brazil))
...
#### Rule Name 1
```
Insert rules here, with concise explanation.
Add as many rules as necessary to make sure
the rest of the contributors of your language
